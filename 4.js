...
const good = input
    .split('\n')
    .reduce((total, phrase) => (check(phrase) ? total + 1 : total), 0);
console.log('Total good phrases:', good); // 466

const strictGood = input
    .split('\n')
    .reduce((total, phrase) => (checkStrict(phrase) ? total + 1 : total), 0);
console.log('Total strict phrases:', strictGood); // 251
